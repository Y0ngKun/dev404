					...
					<div class="_1s38h9c1 _1s38h9c0">
						<span><button
							...
							<form novalidate="" class="_1knjz499">
								...
								<button type="button" class="karrot-button r14vym0 _1s38h9c3 _1s38h9c4 r14vym4 r14vym7 _1knjz49j chatBtn">채팅하기</button></span>
								
								<!-- 로그인 안 한 상태 -->
								<c:if test="${member == null}">
									<div class="login_button">
										<a href="/member/login" style="font-size: 15px; color:#fe7f41; padding:10px; display: block;">로그인</a>
									</div>
									<span><a href="/member/join" style="font-size: 15px; color:#fe7f41; padding:10px; display: block;">회원가입</a></span>
								</c:if>
								
								<!-- 로그인 한 상태 -->
								<c:if test="${ member != null}">
            						 <div class="login_success_area">
				                        <span>회원 ${member.memberName}님 반갑습니다</span>
			                   		 </div>
              					 </c:if>
