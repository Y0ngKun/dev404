...
#### 동네가게 (권용건) - <a href="https://github.com/Y0ngKun/dev404/wiki/%EB%8F%99%EB%84%A4%EA%B0%80%EA%B2%8C(Stores)" >상세보기 - WIKI 이동</a>
- 글 작성, 읽기, 수정, 삭제(CRUD)
- 게시물 리스트
- 게시글 이미지 업로드

#### 중고거래 (김건희) - <a href="#" >상세보기 - WIKI 이동</a>
- 게시글 리스트(AJAX)
- 게시글 수정/삭제
- 관심글
- 채팅(WebSocket)
...
#### 부동산 직거래 (김진아) - <a href="#" >상세보기 - WIKI 이동</a> 
- 글 작성, 읽기, 수정, 삭제(CRUD)

#### 중고차 직거래 (황근호) - <a href="#" >상세보기 - WIKI 이동</a> 
- 글 작성, 읽기, 수정, 삭제(CRUD)
